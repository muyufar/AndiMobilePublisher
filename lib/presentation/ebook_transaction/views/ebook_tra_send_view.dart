...
class EbookTransactionSendView extends StatelessWidget {
  EbookTransactionSendView({Key?key}) : super(key: key);
      ...
      widgetBuilder: Obx(
        () => ListView.builder(
            ...
            itemBuilder: (context, index) =>
                EbookCardListTransactionView(data: controller.listSend[index])),
      ),
    );
  }
}
